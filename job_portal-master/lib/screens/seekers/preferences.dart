...
class MyPreferences extends StatefulWidget {
  MyPreferences({Key key, this.title}) : super(key: key);

  final String title;

  @override
  MyPreferencesState createState() => MyPreferencesState();
}

class MyPreferencesState extends State<MyPreferences> {
  final formKey = GlobalKey<FormState>();
  Map<String, dynamic> formData;
  List<String> programmingList = [
    "Part Time","FullTime","Work From Home",
  ];
            ...
            Padding(
              ...
              child: Align(
                ...
                child: Padding(
                  ...
                  child: Text("What type of Job you are seeking for?",style: TextStyle(fontSize: 18.0,fontStyle: FontStyle.italic),),
                ),
              ),
            ),
            Padding(
            ...
            Padding(
              ...
              child: Align(
                ...
                child: Padding(
                  ...
                  child: Text("Select City for Work",style: TextStyle(fontSize: 18.0,fontStyle: FontStyle.italic),),
                ),
              ),
            ),
            Padding(
